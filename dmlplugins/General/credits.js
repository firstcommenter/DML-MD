module.exports = async (context) => {
  ...
  try {
    const replyText = `◈━━━━━━━━━━━━━━━━◈\n│❒ *Credits, Bitches*\n\nAll hail *daudi*, the badass who built this bot from the ground up. Nobody else gets credit—fuck ‘em. This is my empire, and I run this shit solo.\n\nBow down to *daudi* 🫡`;

    await client.sendMessage(m.chat, {
      text: replyText,
      footer: `TPσɯҽɾҽԃ Ⴆყ 𝙳𝙼𝙻-𝚇𝙼𝙳`,
      buttons: [
